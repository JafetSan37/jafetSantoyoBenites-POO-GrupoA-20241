...
class PreChargedObjects:
    def agregar_elementos():
        ...
        account1 = Bank.add_accounts_list()
        account2 = Bank.add_accounts_list()
        account3 = Bank.add_accounts_list()
        account4 = Bank.add_accounts_list()
        account5 = Bank.add_accounts_list()
        account6 = Bank.add_accounts_list()
        account7 = Bank.add_accounts_list()
        account8 = Bank.add_accounts_list()
        ...
        employee1 = Bank.add_employee()
        employee2 = Bank.add_employee()
        employee3 = Bank.add_employee()
        employee4 = Bank.add_employee()
